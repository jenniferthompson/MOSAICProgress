...
valueBox(
  value = pct_zarit_full,
  caption = "percent of patients<br>with fully completed Zarit",
  color = ifelse(pct_zarit_full < 80, mosaic_col("orange3"), mosaic_col("green1")),
  icon = "glyphicon-heart-empty"
)

```

### Specimen Log Compliance at Discharge
...
### Accelerometer Use Snapshot

```{r}

```

### Accelerometer Use Over Time
