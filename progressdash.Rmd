...
valueBox(
  ...
  caption = "fully or partially completed, <b>3 months</b>",
  color = ifelse(
...
### **3-Month Assessments** (N Eligible: `r nrow(fu_long %>% filter(redcap_event_name == "3 Month Assessment" & fu_elig))`)
...
valueBox(
  ...
  caption = "fully or partially completed, <b>2 months</b>",
  color = ifelse(
...
valueBox(
  ...
  caption = "fully or partially completed, <b>12 months</b>",
  color = ifelse(
...
### **12-Month Assessments** (N Eligible: `r nrow(fu_long %>% filter(redcap_event_name == "12 Month Assessment" & fu_elig))`)
...
### This Will Eventually Have a Sankey Chart or Something

### Patients Eligible but Not Yet Assessed

**3 Months:** `r paste(fu_long %>% filter(fu_elig, !fu_comp, redcap_event_name == "3 Month Assessment") %>% pull(id), collapse = "; ")`

**12 Months:** `r paste(fu_long %>% filter(fu_elig, !fu_comp, redcap_event_name == "12 Month Assessment") %>% pull(id), collapse = "; ")`
